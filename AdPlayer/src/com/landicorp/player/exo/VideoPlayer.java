 ...
 */
package com.landicorp.player.exo;
 ...
 */
public class VideoPlayer implements ExoPlayer.Listener, ChunkSampleSource.EventListener, HlsSampleSource.EventListener, ExtractorSampleSource.EventListener, SingleSampleSource.EventListener, DefaultBandwidthMeter.EventListener, MediaCodecVideoTrackRenderer.EventListener, MediaCodecAudioTrackRenderer.EventListener, StreamingDrmSessionManager.EventListener, DashChunkSource.EventListener, TextRenderer, MetadataRenderer<List<Id3Frame>>, DebugTextViewHelper.Provider {
	...
	public interface RendererBuilder {
		 ...
		 *            {@link VideoPlayer#onRenderers} should be invoked once the
		 ...
		 * {@link VideoPlayer#onRenderers} or
		 * {@link VideoPlayer#onRenderersError} on the player, which may have
		 * been released.
		 */
		void cancel();
	}
	 ...
	 * 
	 * @param renderers
	 *            Renderers indexed by {@link VideoPlayer} TYPE_* constants. An
	...
	/* package */void onRenderers(TrackRenderer[] renderers, BandwidthMeter bandwidthMeter) {
		...
		this.codecCounters = videoRenderer instanceof MediaCodecTrackRenderer ? ((MediaCodecTrackRenderer) videoRenderer).codecCounters : renderers[TYPE_AUDIO] instanceof MediaCodecTrackRenderer ? ((MediaCodecTrackRenderer) renderers[TYPE_AUDIO]).codecCounters : null;
